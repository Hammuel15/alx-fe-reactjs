function UserProfile() {
  return (
    <div className="user-profile sm:p-4 md:p-8 bg-gray-100 max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg  hover:shadow-xl" >
      ...
      <h1 className="hover:text-blue-500 text-xl text-blue-800 my-4 sm:text-lg md:text-xl ">John Doe</h1>
